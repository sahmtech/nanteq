...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'profile_completion_status' => $this->hasUnrestrictedAccess() ? 'completed' : $this->profile_completion_status,
            'phone_code' => $this->phone_code,
            'phone_number' => $this->phone_number,
            'last_progress' =>  new LetterProgressResource($last_progress),
            'has_subscription' => $this->hasUnrestrictedAccess() || ($this->subscription && $this->subscription->status === 'active'),
